package com.jsonkile.testin.ui.composables.screens
...
import com.jsonkile.testin.ui.viewmodels.HomeViewModel
...
fun HomeComposable(homeUiState: HomeViewModel.HomeUiState) {
    ConstraintLayout(
        ...
        val (searchTextField, searchButton, resultsList) = createRefs()
        TextField(
            value = "",
            onValueChange = {},
